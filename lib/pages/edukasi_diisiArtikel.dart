...
class EdukasiDiisiartikel extends StatefulWidget {
  EdukasiDiisiartikel({super.key});

  @override
  _EdukasiDiisiartikelState createState() => _EdukasiDiisiartikelState();
}
class _EdukasiDiisiartikelState extends State<EdukasiDiisiartikel> {
  ...
  Future<void> fetchData() async {
    try {
      Map<String, dynamic> response = await apiService.getDisiArtikel();
      ...
      print('Error fetching digital literasi artikel data: $e');
    }
  }
    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: <Widget>[
          SliverToBoxAdapter(
            child: CustomAppBar(
              title: 'Artikel Edukasi Diisi',
              buttonOnPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => EdukasiDiisi()),
                );
              },
            ),
          ),
                ...
                children: [ 
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => DetailArtikel(detailData: {'id_data':articles[index]['id_data'], 'table': 'disi'})));
                        },
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: Column(
                              ...
                              children: [
                                Image.network(
                                  '${apiService.imgUrl}/digital_literasi/${articles[index]['gambar']}',
