...
class EdukasiDiisi extends StatefulWidget {
  EdukasiDiisi({super.key});

  @override
  _EdukasiDiisiState createState() => _EdukasiDiisiState();
}
class _EdukasiDiisiState extends State<EdukasiDiisi> {
  ...
  Future<void> fetchData() async {
    try {
      Map<String, dynamic> response = await apiService.getDisi();
      ...
      print('Error fetching digital literasi data: $e');
    }
  }
