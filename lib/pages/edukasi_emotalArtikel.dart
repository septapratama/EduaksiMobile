...
class EdukasiEmotalartikel extends StatefulWidget {
  EdukasiEmotalartikel({super.key});

  @override
  _EdukasiEmotalState createState() => _EdukasiEmotalState();
}
class _EdukasiEmotalState extends State<EdukasiEmotalartikel> {
  ...
  Future<void> fetchData() async {
    try {
      Map<String, dynamic> response = await apiService.getEmotalArtikel();
                ...
                children: [ 
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => DetailArtikel(detailData: {'id_data':articles[index]['id_data'], 'table': 'emotal'})));
                        },
                        child: Padding(
